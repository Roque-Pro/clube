...
const Clients = () => {
  ...
  const handleAddClient = async () => {
    ...
    try {
      ...
      // Log da ação
      logAction("create", "clients", newClient.id, newClient.name, `Novo cliente: ${newClient.vehicle} (${newClient.plate})`);
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="bg-card border-border">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleAddClient} className="w-full gradient-primary text-primary-foreground font-semibold">Cadastrar</Button>
              </div>
            </DialogContent>
          </Dialog>
        }
